classdef visensor_imu < robotics.ros.Message
    %visensor_imu MATLAB implementation of visensor_node/visensor_imu
    ...
    properties (Constant)
        MessageType = 'visensor_node/visensor_imu' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.visensor_node.visensor_imu.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.visensor_node.visensor_imu;
            obj.reload(strObj);
        end
    end
end
